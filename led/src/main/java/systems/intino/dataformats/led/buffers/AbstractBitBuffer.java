...
import systems.intino.dataformats.led.buffers.store.ReadOnlyByteStore;
import systems.intino.dataformats.led.util.BitUtils;

import static java.util.Objects.requireNonNull;
import static systems.intino.dataformats.led.util.BitUtils.*;
