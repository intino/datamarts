...
import systems.intino.datamarts.subjectstore.SubjectStore.RegistryException;
...
public class SqlRegistry implements Registry {
	...
	public SqlRegistry(String identifier, Connection connection) {
		try {
	...
	private void initTables() throws SQLException {
		...
		statement.executeUpdate(InitTables.replace("[id]", String.valueOf(id)));
		connection.commit();
	}
	...
	private class StatementProvider {
		...
		private PreparedStatement create(String sql) throws SQLException {
			return connection.prepareStatement(sql.replace("[id]", String.valueOf(id)));
		}
